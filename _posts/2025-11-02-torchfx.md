...
Compared to LLVM IR, FX is a more high-level IR that generates graph representation consisting standard torch.nn modules or call methods/functions.
...
call_module  activation  activation  (clamp,)       {}
