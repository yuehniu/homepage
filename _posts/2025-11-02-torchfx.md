...
the difficulties of using Tensorflow. And the main pain poit is **you need to build the whole computation graph before you start to train your model**.
...
This post is aimed to understand how the graph mode in PyTorch develops, and key techniques for enabling graph mode in PyTorch.
